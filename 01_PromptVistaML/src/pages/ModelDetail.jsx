                ...
                {model.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-sm">
                      <span className="inline-block px-2 py-1 text-xs rounded bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-100 dark:border-blue-800">
                        {feature.type}
                      </span>
                    </td>
                    ...
                    <td className="py-3 px-4 text-sm">
                      {feature.type === "enum" && feature.options ? (
                        <div className="flex flex-wrap gap-1">
                          {feature.options.map((option, i) => (
                            <span
                              key={i}
                              className="inline-block px-2 py-1 text-xs rounded bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 border border-purple-100 dark:border-purple-800"
                            >
                              {option}
                            </span>
                          ))}
